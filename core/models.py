...
class Session(models.Model):
    ...
    case = models.ForeignKey(CourtCase, on_delete=models.CASCADE, db_column='case_id')
    judge = models.ForeignKey(User, on_delete=models.CASCADE, db_column='judge_id')
...
class FileTransfer(models.Model):
    ...
    receiver = models.ForeignKey(User, on_delete=models.CASCADE, related_name='received_transfers', db_column='receiver_id')
